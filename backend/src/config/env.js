...
const envHalf = process.env.CLOUDHUB_SECRET_HALF || 'cloudhub-dev-secret-half';
...
export const env = {
	...
	authCookieName: process.env.AUTH_COOKIE_NAME || 'cloudhub_session',
	authSessionTtlHours: Number(process.env.AUTH_SESSION_TTL_HOURS || 24 * 14),
	authSecret: process.env.AUTH_SECRET || process.env.CLOUDHUB_SECRET_HALF || 'cloudhub-dev-auth-secret',
	encryptionKey,
